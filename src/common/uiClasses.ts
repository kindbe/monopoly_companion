...
export const kickerClass =
  "mb-2 mt-0 text-xs font-extrabold uppercase tracking-normal text-violet-600 dark:text-emerald-300"
...
export const checkRowClass =
  "my-2.5 grid grid-cols-[auto_1fr] items-center gap-1.5 font-extrabold"
...
export const propertyTitleClass =
  "text-[clamp(1.3rem,4vw,2rem)] uppercase text-[#1b1830]"
