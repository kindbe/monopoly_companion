import { actionRowClass, finePrintClass, kickerClass, panelClass, primaryActionClass, secondaryActionClass, setupGridClass, startBandClass } from "@/common/uiClasses";
      ...
      <section className={panelClass}>
        ...
        {phase === "bidding" ? (
          <div className={finePrintClass}>
            <p>{currentProperty ?? "Current property"} with {countdownRemaining}s remaining.</p>
            <p>Current bid: ${currentBid}{currentBidderName ? ` by ${currentBidderName}` : ""}</p>
          </div>
        ) : null}
