...
import { finePrintClass, mastheadTitleClass, panelClass, secondaryActionClass } from "@/common/uiClasses";
...
export function CompleteScreen({ players, completedBids, restart, inspectProperty, lastWinnerName }: CompleteScreenProps) {
  return (
