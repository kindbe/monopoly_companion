...
export function createSignalingHandler(
  ...
  function joinSignaling(
    ...
    transport.send(clientId, {
      type: "signaling-joined",
      joinCode: session.joinCode,
      hostPeerId: session.hostClientId
    })
    transport.send(session.hostClientId, {
